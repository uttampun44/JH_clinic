    ...
    const handleSubmit = (event: FormEvent) => {
        ...
        post(route('drugs.store'), {
            onSuccess: () => {
                clearErrors()
                reset();
                toast.success("Drug creat successfully");
            },
            onError: () => {
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="formGrid my-2 grid grid-cols-3 gap-4">
                                ...
                                <div className="dosage">
                                    ...
                                    <Input type="text" value={data.dosage_from} onChange={(e) => setData("dosage_from", e.target.value)} className="rounded-md my-1 w-full" />
                                    {
                                        errors.dosage_from && (
